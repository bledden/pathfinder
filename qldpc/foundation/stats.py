"""Evidentiary-discipline helpers: Wilson CIs, TOST equivalence, Holm-Bonferroni / BH-FDR,
failure-budget sizing, and a pre-registration writer."""
import json
import math
import time
...
def write_prereg(path, **fields):
    fields["written_unix"] = int(time.time())
