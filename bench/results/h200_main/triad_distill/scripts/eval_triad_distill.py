"""Full 8-noise PFWL3S eval for Triad-distill ckpts at d=7, 100K shots."""
import sys, os, json
...
PF_CKPTS = [f"/workspace/persist/checkpoints/pathfinder_triad_distill_d7_seed{s}/best_model.pt" for s in (0, 1, 2)]
...
print(f"d=7: {len(paths_present)} Triad-distill PF model(s)", flush=True)
...
with open("/workspace/persist/results/ensemble_triad_distill_d7.json", "w") as f:
