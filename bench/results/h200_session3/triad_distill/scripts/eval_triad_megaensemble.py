"""Mega-ensemble eval: combine all distilled PF ckpts as one big PF voter.
Includes warm-init H=384 (3 seeds) + H=512 (3 seeds) + PF+PM (1 seed).
Tests whether more seeds of varied recipes finally break the Triad."""
import sys, os, json
...
PF_CKPTS = [
    "/workspace/persist/checkpoints/pathfinder_triad_warminit_d7_seed0/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_triad_warminit_d7_seed1/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_triad_warminit_d7_seed2/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_triad_h512_d7_seed0/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_triad_h512_d7_seed1/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_triad_h512_d7_seed2/best_model.pt",
    "/workspace/persist/checkpoints/pathfinder_pf_pm_d7_seed0/best_model.pt",
]
...
print(f"d=7 MEGA-ENSEMBLE: {len(paths_present)} PF model(s)", flush=True)
...
with open("/workspace/persist/results/ensemble_triad_megaensemble_d7.json", "w") as f:
