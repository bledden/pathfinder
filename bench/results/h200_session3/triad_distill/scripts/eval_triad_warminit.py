"""Full 8-noise PFWL3S eval for warm-init Triad ckpts at d=7, 100K shots."""
import sys, os, json
...
PF_CKPTS = [f"/workspace/persist/checkpoints/pathfinder_triad_warminit_d7_seed{s}/best_model.pt" for s in (0, 1, 2)]
...
print(f"d=7: {len(paths_present)} warm-init Triad PF model(s)", flush=True)
...
with open("/workspace/persist/results/ensemble_triad_warminit_d7.json", "w") as f:
