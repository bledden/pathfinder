...
Run from the repo root: `python bench/triton_ler_test.py`
"""
...
ck = torch.load(os.path.join(REPO, "train/checkpoints/d7_final/best_model.pt"), weights_only=False, map_location="cuda")
